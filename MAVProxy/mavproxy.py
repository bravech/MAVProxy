...
if __name__ == '__main__':
    ...
    parser.add_option("--default-modules", default="log,signing,rally,fence,param,relay,arm,mode,calibration,rc,misc,cmdlong,battery,terrain,output,layout,console,resett,pressure,manual", help='default module list')
